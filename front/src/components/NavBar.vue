    ...
    <nav id="navbar" class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand d-flex justify-content-center align-items-center gap-2 text-light" href="#">
                <img alt="Logo" class="d-inline-block align-text-top logoEagle" src="../assets/logo_circle.svg"
                    width="48" />
                Eagle Fox
            </a>

            <button aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation"
                class="navbar-toggler" data-bs-target="#navbarNavAltMarkup" data-bs-toggle="collapse" type="button">
                    ...
                    <div class="dropstart">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start">
                            <li class="d-flex justify-content-center align-items-center">
                                ...
                                <a class="dropdown-item w-50" href="#" @click="changeLanguage('spain')">{{
                                    $t('lang.lang_es') }}</a>
                            </li>
                            <li class="d-flex justify-content-center align-items-center">
                                <img alt="gl_flag" src="../assets/flags/gl.svg" width="32" />
                                <a class="dropdown-item w-50" href="#" @click="changeLanguage('galician')">{{
                                    $t('lang.lang_gl') }}</a>
                            </li>
                            <li class="d-flex justify-content-center align-items-center">
                            ...
                            <li class="d-flex justify-content-center align-items-center">
                                ...
                                <a class="dropdown-item w-50" href="#" @click="changeLanguage('germany')">{{
                                    $t('lang.lang_de') }}</a>
                            </li>
                        </ul>
                    </div>

...
let homeTextPackage = {
  ...
  home_t3:
    'We provide our users with an interactive map to monitor their pet at all times. It has high accuracy and high detail.',
  home_t4: 'What we offer to our users:',
  home_t5: 'Register your collar!!',
  home_t6:
    'Inside the box of your Eagle Fox collar, there will be a card with the collar code. You will need to enter that code in the Pet Registration section.',
  home_t7: 'Enter the code!!',
  home_t8: 'With the provided code, you can register your pet',
  home_t9: 'Ready, now you can see your pet!!',
  home_t10:
    'Now you can use all the monitoring features of your little furry friend',
  home_t11: 'How to set up your Eagle Fox collar?',
  home_t12: 'Real-time monitoring.',
  home_bd1: 'Positioning of your pets on a map in real time',
  home_bd2: 'Set points of interest and establish custom routes',
  home_bd3:
    'Get information about your pet, such as walk duration, calories burned ...',
...
let loginTextPackage = {
  ...
  login_message: 'We will never share your email address with anyone else.',

...
let homeTextPackage = {
    ...
    home_t3: 'We provide our users with an interactive map to monitor their pet at all times. It boasts high precision and detail.',
    home_t4: 'What we offer our users:',
    home_t5: 'Register your collar!',
    home_t6: 'Inside your Eagle Fox collar box, there will be a card with the collar code. You should enter that code in the Pet Registration section.',
    home_t7: 'Enter the code!',
    home_t8: 'With the provided code, you can register your pet.',
    home_t9: 'Ready, now you can see your pet!',
    home_t10: 'Now you can use all the monitoring features for your little furry friend.',
    home_t11: 'How to set up your Eagle Fox collar?',
    home_bd1: 'Positioning of your pets on a real-time map',
    home_bd2: 'Marking points of interest and establishing custom routes',
    home_bd3: 'Getting information about your pet, such as walk time, calories burned...',
